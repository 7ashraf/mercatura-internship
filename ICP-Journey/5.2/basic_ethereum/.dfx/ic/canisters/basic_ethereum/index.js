...
export const canisterId = process.env.CANISTER_ID_BASIC_ETHEREUM;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./basic_ethereum.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the basic_ethereum canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./basic_ethereum.did.js")._SERVICE>}
 */
export const basic_ethereum = createActor(canisterId);
